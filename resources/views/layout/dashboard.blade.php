...
<html>
  ...
  <body class="hold-transition skin-blue sidebar-mini">
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="index2.html" class="logo">
          ...
          <span class="logo-lg"><b>Admin</b>Logistic</span>
        </a>
          ...
          <ul class="sidebar-menu" data-widget="tree">
            ...
            <span class="pull-right-container">
              ...
              <ul class="treeview-menu">
                <li class="active"><a href="index.html"><i class="fa fa-circle-o"></i>New request</a></li>
                <li><a href="index2.html"><i class="fa fa-circle-o"></i> Reject Request</a></li>
              </ul>
            </li>
            <li class="treeview">
              <a href="#">
    ...
    <!-- Bootstrap WYSIHTML5 -->
    <script src="{{url('plugins/whysihtml/bootstrap3-wysihtml5.all.min.js')}}"></script>
    <!-- daterangepicker -->
